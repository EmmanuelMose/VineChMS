...
exports.resendVerificationService = exports.resetPasswordService = exports.verifyResetCodeService = exports.forgotPasswordService = exports.loginService = exports.verifyService = exports.registerService = void 0;
...
const resetPasswordService = async (email, newPassword) => {
    ...
    await db_1.default
        ...
        .where((0, drizzle_orm_1.eq)(schema_1.users.userId, user.userId));
    await (0, mailer_1.sendEmail)(email, "Password Reset Successful - VineChMS", `Your password has been successfully reset.`, `
...
const resendVerificationService = async (email) => {
    ...
    await db_1.default
        ...
        .where((0, drizzle_orm_1.eq)(schema_1.users.userId, user.userId));
    await (0, mailer_1.sendEmail)(email, "Resend Verification - VineChMS", `Your new verification code is ${verificationCode}`, `
