...
ALTER TABLE "group_join_requests" ADD CONSTRAINT "group_join_requests_group_id_groups_group_id_fk" FOREIGN KEY ("group_id") REFERENCES "public"."groups"("group_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "group_join_requests" ADD CONSTRAINT "group_join_requests_member_id_members_member_id_fk" FOREIGN KEY ("member_id") REFERENCES "public"."members"("member_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "join_req_group_idx" ON "group_join_requests" USING btree ("group_id");--> statement-breakpoint
CREATE INDEX "join_req_member_idx" ON "group_join_requests" USING btree ("member_id");--> statement-breakpoint
CREATE INDEX "join_req_status_idx" ON "group_join_requests" USING btree ("status");--> statement-breakpoint
