...
import { createAttendance } from "../../../../Features/attendance/attendanceAPI";
...
export default function CreateAttendance({ isOpen, onClose, onSuccess, members, services }: CreateAttendanceProps) {
  ...
  return (
    <div className="create-attendance-overlay" onClick={onClose}>
      <div className="create-attendance-modal" onClick={(e) => e.stopPropagation()}>
        <div className="create-attendance-header">
          <h3>Record Attendance</h3>
          <button onClick={onClose} className="create-attendance-close">
            <FiX size={20} />
          </button>
        </div>
        <form onSubmit={handleSubmit} className="create-attendance-form">
          <div className="create-attendance-group">
            <label>Member *</label>
            <select
          ...
          <div className="create-attendance-checkbox">
            <label className="create-attendance-checkbox-label">
              <input
                type="checkbox"
          ...
          <div className="create-attendance-row">
            <div className="create-attendance-group">
          ...
          {error && <div className="create-attendance-error">{error}</div>}

          <div className="create-attendance-actions">
            <button type="button" onClick={onClose} className="create-attendance-cancel">
              Cancel
            </button>
            <button type="submit" className="create-attendance-save" disabled={loading}>
