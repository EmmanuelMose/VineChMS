...
import "./UpdateMemberExpense.css";

interface UpdateMemberExpenseProps {
  isOpen: boolean;
  onClose: () => void;
  onSuccess: () => void;
  expense: Expense;
...
export default function UpdateMemberExpense({ isOpen, onClose, onSuccess, expense, categories, members }: UpdateMemberExpenseProps) {
      ...
      <div className="member-expense-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <form onSubmit={handleSubmit} className="member-expense-modal-form">
          ...
          <div className="member-expense-modal-actions">
            ...
            <button type="submit" className="member-expense-modal-submit" disabled={loading}>
