...
export default function Visitors() {
  ...
  if (loading) {
    return (
      <div className="member-visitors-loading">
        <div className="member-visitors-loading-spinner"></div>
  ...
  return (
    <div className="member-visitors-page">
      <div className="member-visitors-header">
        <div>
          <h2 className="member-visitors-title">Visitors</h2>
          <p className="member-visitors-subtitle">Track and manage church visitors</p>
        </div>
        {canManage && (
          <button className="member-visitors-add-btn" onClick={handleCreate}>
            <FiPlus size={18} />
            Add Visitor
          </button>
        )}
      ...
      <div className="member-visitors-stats">
        <div className="member-visitors-stat">
          <span className="member-visitors-stat-value">{totalVisitors}</span>
          <span className="member-visitors-stat-label">Total Visitors</span>
        </div>
        <div className="member-visitors-stat">
          <span className="member-visitors-stat-value">{convertedVisitors}</span>
          <span className="member-visitors-stat-label">Converted to Members</span>
        </div>
        <div className="member-visitors-stat">
          <span className="member-visitors-stat-value">{totalVisitors - convertedVisitors}</span>
          <span className="member-visitors-stat-label">Unconverted</span>
        </div>
        <div className="member-visitors-stat">
          <span className="member-visitors-stat-value">
            {totalVisitors > 0 ? Math.round((convertedVisitors / totalVisitors) * 100) : 0}%
          </span>
          <span className="member-visitors-stat-label">Conversion Rate</span>
        </div>
      </div>

      <div className="member-visitors-search">
        <div className="member-visitors-search-wrapper">
          <FiSearch className="member-visitors-search-icon" />
          <input
            type="text"
            placeholder="Search visitors..."
            value={searchTerm}
            onChange={(e) => setSearchTerm(e.target.value)}
            className="member-visitors-search-input"
          />
          {searchTerm && (
            <button
              onClick={() => setSearchTerm("")}
              className="member-visitors-search-clear"
            >
              <FiX size={16} />
            </button>
          )}
      ...
      <div className="member-visitors-table-wrapper">
        {filteredVisitors.length > 0 ? (
          <table className="member-visitors-table">
            <thead>
              <tr>
                <th>Name</th>
                <th>Email</th>
            ...
            <tbody>
              {filteredVisitors.map((visitor) => (
                <tr key={visitor.visitorId}>
                  <td className="member-visitors-name">{visitor.fullName}</td>
                  <td>{visitor.email || "—"}</td>
                  <td>{visitor.phone || "—"}</td>
                  <td>{formatDate(visitor.visitedDate)}</td>
                  <td>{getServiceName(visitor.serviceId)}</td>
                  <td>
                    <span className={`member-visitors-status ${visitor.isMember ? "status-member" : "status-visitor"}`}>
                      {visitor.isMember ? "Member" : "Visitor"}
                    </span>
                  </td>
                  <td>
                    <div className="member-visitors-actions">
                      {canManage && (
                        <>
                          <button className="member-visitors-action-edit" onClick={() => handleEdit(visitor)}>
                            <FiEdit2 size={14} /> Edit
                          </button>
                          {!visitor.isMember && (
                            <button
                              className="member-visitors-action-convert"
                          ...
                          <button
                            className="member-visitors-action-delete"
                            onClick={() => {
          ...
          <div className="member-visitors-empty">
      ...
      {filteredVisitors.length > 0 && (
        <div className="member-visitors-count">
      ...
      {showModal && (
        <div className="member-visitors-modal-overlay" onClick={() => setShowModal(false)}>
          <div className="member-visitors-modal" onClick={(e) => e.stopPropagation()}>
            <div className="member-visitors-modal-header">
              <h3>{editingVisitor ? "Edit Visitor" : "Add Visitor"}</h3>
              <button className="member-visitors-modal-close" onClick={() => setShowModal(false)}>
                Close
              </button>
            </div>
            <form onSubmit={handleSubmit} className="member-visitors-modal-form">
              <div className="member-visitors-form-group">
              ...
              <div className="member-visitors-form-row">
                <div className="member-visitors-form-group">
                  <label>Email</label>
                  <input
                    type="email"
              ...
              <div className="member-visitors-modal-actions">
                <button
                  type="button"
                  className="member-visitors-modal-cancel"
                ...
                <button
                  type="submit"
                  className="member-visitors-modal-submit"
                  disabled={submitting}
                >
      ...
      {showDeleteModal && (
        <div className="member-visitors-modal-overlay" onClick={() => setShowDeleteModal(false)}>
          <div className="member-visitors-modal member-visitors-modal-small" onClick={(e) => e.stopPropagation()}>
            <div className="member-visitors-modal-header">
              <h3>Delete Visitor</h3>
              <button className="member-visitors-modal-close" onClick={() => setShowDeleteModal(false)}>
                Close
              </button>
            </div>
            <div className="member-visitors-modal-body">
              <p>Are you sure you want to delete this visitor?</p>
              <p className="member-visitors-modal-warning">This action cannot be undone.</p>
            </div>
            <div className="member-visitors-modal-actions">
              <button className="member-visitors-modal-cancel" onClick={() => setShowDeleteModal(false)}>
                Cancel
              </button>
              <button className="member-visitors-modal-danger" onClick={handleDelete} disabled={submitting}>
      ...
      {showConvertModal && (
        <div className="member-visitors-modal-overlay" onClick={() => setShowConvertModal(false)}>
          <div className="member-visitors-modal member-visitors-modal-convert" onClick={(e) => e.stopPropagation()}>
            <div className="member-visitors-modal-header">
              <h3>Convert Visitor to Member</h3>
              <button className="member-visitors-modal-close" onClick={() => setShowConvertModal(false)}>
                Close
              </button>
            </div>
            <div className="member-visitors-modal-body">
            ...
            <div className="member-visitors-modal-actions">
              ...
              <button
                type="button"
                className="member-visitors-modal-convert-btn"
